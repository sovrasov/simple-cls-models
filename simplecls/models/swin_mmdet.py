...
from mmcv.utils import to_2tuple, get_logger
...
class SwinTransformer(BaseModule):
    ...
    def forward(self, x):
        ...
        return torch.nn.functional.adaptive_avg_pool2d(outs[-1], 1).view(outs[-1].shape[0], -1)


def get_swin(num_classes, **kwargs):
    return nn.Sequential(SwinTransformer(**kwargs), torch.nn.Linear(768, num_classes))
